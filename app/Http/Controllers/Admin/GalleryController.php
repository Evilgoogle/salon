...
class GalleryController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->info = (object)[];
        $this->info->head = 'Фотогалерея';
        $this->info->url = 'gallery';
        $this->info->modelName = 'Gallery';
        $this->middleware('role:superadmin');
    }

    public function index()
    {
        $items = Gallery::orderBy('position', 'ASC')->get();
        $info = $this->info;

        return view('admin.gallery.index', compact(['items', 'info']));
    }
    ...
    public function add()
    {
        ...
        return view('admin.gallery.insert', compact(['info']));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.gallery.insert', compact(['item', 'info']));
    }
