...
@section('app_content')
    ...
    $services = [
        ...
        1 => (object)[
            ...
            'image' => 'gal_2.jpg',
            'title' => 'Стандарт боди',
            'desc' => 'Если вы хотите расслабиться и получить максимальное удовольствие не сравнимое ни с чем то это идеальный выбор удовольствие не сравнимое ни с чем то это идеальный выбор!Если вы хотите расслабиться и получить максимальное удовольствие не сравнимое ни с чем то это идеальный выбор!Если вы хотите расслабиться и получить максимальное удовольствие не сравнимое ни с чем то это идеальный выбор!'
        ],
        2 => (object)[
            'id' => 1,
            ...
            'image' => 'gal_3.jpg',
            'title' => 'Ветка сакуры',
            'desc' => 'Если вы хотите расслабиться и получить максимальное удовольствие не сравнимое ни с чем то это идеальный выбор! Если вы хотите расслабиться и получить максимальное удовольствие не сравнимое ни с чем то это идеальный выбор!'
        ],
        3 => (object)[
            'id' => 1,
            'icon' => '<i class="far fa-heart"></i>',
