                    ...
                    <table class="table table-bordered table-striped js-table">
                        ...
                        @foreach ($items as $item)
                            <tr id="{{ $item->id }}">
                                ...
                                <td>
                                    <input type="checkbox" class="enable filled-in chk-col-pink" name="enable" data-id="{{ $item->id }}" id="enable_{{ $item->id }}" {{ $item->enable ? 'value=1 checked' : 'value=0'}}>
                                ...
                                <td>
                                    ...
                                    <a href="/admin/{{ $info->url }}/remove/{{ $item->id }}" class="js_del_data entry_del btn bg-pink"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
